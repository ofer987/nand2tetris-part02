...
module JackCompiler
  class ClassFieldVariableStatement < Statement
    REGEX = RegularExpressions::CLASS_FIELD_VAR_STATEMENT

    def create_elements(parent_node, lines)
      result = lines.match(REGEX)
      result_node = document.create_element(CLASS_FIELD_VAR_DESCRIPTION)
