...
module JackCompiler
  class ArrayAssignmentStatement < ExpressionStatement
    ...
    def create_elements(parent_node, lines)
      ...
      evaluation_node_type = document.create_element(EVALUATION_TYPE_STATEMENT, INFIX_EXPRESSION)
      ...
      next_statements(expression_node, result[1], next_expression_classes)
