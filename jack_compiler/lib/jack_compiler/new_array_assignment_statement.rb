...
module JackCompiler
  class NewArrayAssignmentStatement < Statement
    REGEX = RegularExpressions::ARRAY_NEW_EXPRESSION
    ...
    def create_elements(parent_node, lines)
      ...
      evaluation_node_type = document.create_element(EVALUATION_TYPE_STATEMENT, NEW_ARRAY_TYPE)
